...
# docker run -v /home/olivas/icecube_deep_learning:/opt/icecube_deep_learning -u $(id -u):$(id -g) -it tensorflow/tensorflow /opt/icecube_deep_learning/functional_api.py
...
hidden_layer = Dense(args.n_hidden_units, activation=args.activation)(flatten_layer)
output_layer = Dense(n_output_units, activation='softmax')(hidden_layer)
